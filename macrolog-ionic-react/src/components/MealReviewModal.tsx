...
import { closeOutline, checkmarkOutline, createOutline, trashOutline, leafOutline, checkmarkCircleOutline, thumbsUpOutline, warningOutline, trashBinOutline } from 'ionicons/icons';
          ...
          <div className="mr-summary">
            <div className="mr-summary-row">
              ...
              <div className="mr-score-box">
                <div className="mr-score-val" style={{ color: scoreCol }}>
                  <IonIcon icon={healthIcon(avgScore)} />
                  {avgScore}
                </div>
                <div className="mr-score-lbl">{getHealthRating(avgScore)}</div>
              </div>
            </div>
